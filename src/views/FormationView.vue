      ...
      <div class="formation-card">
        ...
        <div class="formation-details">
          ...
          <p class="formation-description">
            Obtention du Baccalauréat mention bien avec les spécialités NSI et Maths. 
          </p>
          <div class="formation-info">
            <p><strong>Durée:</strong> 2019 - 2022</p>
            <p><strong>Lieu:</strong> Lycée Georges Brassens, Rive-de-Gier</p>
          </div>
        </div>
      </div>
...
<style src="../assets/FormationView.css"></style>
